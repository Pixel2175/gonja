...
```
go get github.com/pixel2175/gonja/v2
```
...
* **gonja** API documentation is available on [godoc](https://godoc.org/github.com/pixel2175/gonja/v2) ;
...
* All references to `gonja` need to be changed from `"github.com/nikolalohinski/gonja"` to `"github.com/pixel2175/gonja/v2"`
